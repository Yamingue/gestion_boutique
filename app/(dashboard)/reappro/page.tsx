              ...
              commandes.map((c) => (
                <tr key={c.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-5 py-3 font-mono font-medium text-brand-bleu">
                    <Link href={`/reappro/${c.id}`} className="hover:underline">{c.numero}</Link>
                  </td>
                  ...
                  <td className="px-5 py-3 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <Link href={`/reappro/${c.id}`} className="text-xs text-brand-bleu hover:underline font-medium">
                        Voir
                      </Link>
